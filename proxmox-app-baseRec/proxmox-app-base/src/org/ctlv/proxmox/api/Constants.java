...
public class Constants {
	...
	public static String USER_NAME = "elabbadi";
	public static String PASS_WORD = "H-ENBGAv";
	
	public static String HOST = "srv-px5.insa-toulouse.fr";
	...
	public static String CT_BASE_NAME = "ct-tpgei-ctlv-A24-ct1";  // exemple: ct-tpgei-ctlv-A23-ct � concat�ner avec le num�ro du CT
	public static long CT_BASE_ID = -1;	 // � modifier (cf. sujet de tp)
